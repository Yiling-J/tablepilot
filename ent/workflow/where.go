...
func Nanoid(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldEQ(FieldNanoid, v))
}
...
func CreatedAtIsNil() predicate.Workflow {
	return predicate.Workflow(sql.FieldIsNull(FieldCreatedAt))
}

// CreatedAtNotNil applies the NotNil predicate on the "created_at" field.
func CreatedAtNotNil() predicate.Workflow {
	return predicate.Workflow(sql.FieldNotNull(FieldCreatedAt))
}
...
func NanoidEQ(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldEQ(FieldNanoid, v))
}

// NanoidNEQ applies the NEQ predicate on the "nanoid" field.
func NanoidNEQ(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldNEQ(FieldNanoid, v))
}

// NanoidIn applies the In predicate on the "nanoid" field.
func NanoidIn(vs ...string) predicate.Workflow {
	return predicate.Workflow(sql.FieldIn(FieldNanoid, vs...))
}

// NanoidNotIn applies the NotIn predicate on the "nanoid" field.
func NanoidNotIn(vs ...string) predicate.Workflow {
	return predicate.Workflow(sql.FieldNotIn(FieldNanoid, vs...))
}

// NanoidGT applies the GT predicate on the "nanoid" field.
func NanoidGT(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldGT(FieldNanoid, v))
}

// NanoidGTE applies the GTE predicate on the "nanoid" field.
func NanoidGTE(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldGTE(FieldNanoid, v))
}

// NanoidLT applies the LT predicate on the "nanoid" field.
func NanoidLT(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldLT(FieldNanoid, v))
}

// NanoidLTE applies the LTE predicate on the "nanoid" field.
func NanoidLTE(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldLTE(FieldNanoid, v))
}

// NanoidContains applies the Contains predicate on the "nanoid" field.
func NanoidContains(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldContains(FieldNanoid, v))
}

// NanoidHasPrefix applies the HasPrefix predicate on the "nanoid" field.
func NanoidHasPrefix(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldHasPrefix(FieldNanoid, v))
}

// NanoidHasSuffix applies the HasSuffix predicate on the "nanoid" field.
func NanoidHasSuffix(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldHasSuffix(FieldNanoid, v))
}

// NanoidIsNil applies the IsNil predicate on the "nanoid" field.
func NanoidIsNil() predicate.Workflow {
	return predicate.Workflow(sql.FieldIsNull(FieldNanoid))
}

// NanoidNotNil applies the NotNil predicate on the "nanoid" field.
func NanoidNotNil() predicate.Workflow {
	return predicate.Workflow(sql.FieldNotNull(FieldNanoid))
}

// NanoidEqualFold applies the EqualFold predicate on the "nanoid" field.
func NanoidEqualFold(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldEqualFold(FieldNanoid, v))
}

// NanoidContainsFold applies the ContainsFold predicate on the "nanoid" field.
func NanoidContainsFold(v string) predicate.Workflow {
	return predicate.Workflow(sql.FieldContainsFold(FieldNanoid, v))
}
