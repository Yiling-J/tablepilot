...
func (tcd *TableColumnDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(tablecolumn.Table, sqlgraph.NewFieldSpec(tablecolumn.FieldID, field.TypeInt))
...
func (tcdo *TableColumnDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{tablecolumn.Label}
	default:
		return nil
	}
}
