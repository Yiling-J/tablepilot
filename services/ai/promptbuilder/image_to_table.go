...
func NewNewImageToTableBuilder(prompt string) *ImageToTableBuilder {
	...
	el.CreateText(`{"table_name":"user_info","columns":[{"name":"name","description":"The full name of the user","type":"string"},{"name":"age","description":"The age of the user in years","type":"integer"},{"name":"job","description":"The occupation of the user","type":"string"}],"rows":[["Jack",24,"Doctor"],["Amy",36,"Teacher"]]}
`)
