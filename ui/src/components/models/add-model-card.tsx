...
export function AddModelCard({ onClick, disabled }: AddModelCardProps) {
  return (
    <Card
      className={`min-h-[250px] bg-card/60 backdrop-blur-sm shadow-md hover:shadow-accent/50 transition-all duration-300 flex flex-col items-center justify-center text-center p-6 ${
        disabled
